...
public interface DataSource {
    ...
    /**
     *Returns a data access object for  {@link elagin.dmitry.tasktrackingsystem.model.entities.Project}
     * @see ProjectDAO
     */
    ProjectDAO getProjectDAO();

    /**
     *Returns a data access object for {@link elagin.dmitry.tasktrackingsystem.model.entities.User}
     * @see UserDAO
     */
    UserDAO getUserDAO();

    /**
     *Returns a data access object for {@link elagin.dmitry.tasktrackingsystem.model.entities.Task}
     * @see TaskDAO
     */
    TaskDAO getTaskDAO();
